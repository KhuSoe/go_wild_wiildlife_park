...
<!-- Bootstrap 5 CSS link -->
  ...
  <style>
    body {
      ...
      background-image: url('https://img.freepik.com/premium-photo/jaguar-god-jungle-generative-ai_634423-1872.jpg?size=626&ext=jpg&ga=GA1.1.839138248.1690820211&semt=ais');
      padding: 20px;
      font-size: 20px;
    }
